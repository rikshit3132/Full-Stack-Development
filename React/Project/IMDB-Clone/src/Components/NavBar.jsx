...
const NavBar = () => {
  return (
    <>
      <div className="flex items-center space-x-25 p-2   text-center bg-gray-300">
        <Link to="/">
          <img
            className="w-12.5"
        ...
        <Link className="text-blue-700 text-2xl font-bold" to="/">
          Movies
        </Link>
        <Link className="text-blue-700 text-2xl font-bold" to="/watchlist">
          WatchList
        </Link>
      </div>
    </>
